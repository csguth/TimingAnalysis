...
Inherits from \hyperlink{classTiming__Analysis_1_1Edge}{Edge}. Template class which represents a single edge of the graph model. In a circuit, a single fanout edge is a logic gate output which has only one input connected to it.  
