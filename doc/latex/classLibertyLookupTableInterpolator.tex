...
\begin{DoxyCompactList}\small\item\em Truncates \hyperlink{classTransitions}{Transitions$<$double$>$} to \hyperlink{classTransitions}{Transitions$<$double$>$} $\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$ does nothing... \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Truncates \hyperlink{classTransitions}{Transitions$<$double$>$} to \hyperlink{classTransitions}{Transitions$<$double$>$} $\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$$\ast$ does nothing... 
