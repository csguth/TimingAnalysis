...
Adds new capacitor to nodes list. 
...
Adds new resistor to nodes list. 
...
Sets name and lumped\-Capacitance attributes. 
...
Redefinition of $<$$<$ operator. Inserts description including node name, index, capacitance and resistors list. 
